                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <button
                                        className="ml-4 px-4 py-2 bg-primary text-white rounded-md text-sm font-medium hover:bg-primary/90"
                                    >
                                        문의하기
                                    </button>
                                </div>
                    ...
                    <section className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <p className="text-gray-600 mb-4">
                            결제와 관련 없는 일반적인 문의가 필요하다면, 아래 버튼을 눌러 주세요.
                        </p>
                        <button
                            className="px-6 py-3 bg-primary text-white rounded-md font-semibold text-lg hover:bg-primary/90">
                            문의하기
                        </button>
                    </section>

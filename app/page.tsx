                      ...
                      <div key={image.id} className="group">
                        ...
                        <div className="mt-2 flex justify-between items-start">
                          <h3 className="text-base font-medium">
                            <Link href={`/detail/${image.id}`} className="hover:text-primary transition-colors">
                              {image.title}
                            </Link>
                          </h3>
                          {image.bookable && (
            ...
            <div>
              ...
              <ul className="space-y-2">
                {categories
                  ...
                  .map((category) => (
                    <li key={category}>
                      <button className="text-gray-400 hover:text-white" onClick={() => handleCategoryChange(category)}>
                        {category}
                      </button>
                    </li>
                  ))}

...
export default function NewMessagePage() {
  ...
  const handleSelectContact = (selectedUser: User) => {
    ...
    if (selectedUser.type === "event") {
      router.push("/messages/msg5") // Navigate to the event message example
    } else {
      router.push("/messages/msg1") // Navigate to the personal message example
    }
  }
            ...
            {isSearching ? (
              ...
              <div>
                ...
                <div className="p-4 border-t">
                  <button
                    onClick={() => router.push("/messages/group/new")}

    ...
    return (
      <div className="p-4">
        {showPhotoUpload ? (
          ...
          <button onClick={() => setShowPhotoUpload(true)} className="mb-3 text-xs text-primary hover:underline">
            사진 추가하기
          </button>
        )}
        ...
        {isEditingDday ? (
          <div className="space-y-2">
            ...
            <div className="flex justify-end space-x-2">
              <button onClick={() => setIsEditingDday(false)} className="px-2 py-1 text-xs border rounded">
                취소
              </button>
          ...
          <div className="bg-primary/10 p-3 rounded">
            ...
            <button onClick={() => setIsEditingDday(true)} className="mt-2 text-xs text-primary hover:underline">
              수정
            </button>
          </div>
        )}
            ...
            posts.map((post: any, index: number) => (
              <div key={index} className="border-b pb-3">
                ...
                <div className="flex gap-2 mt-2">
                  <Link href={`/posts/edit/${post.id}`} className="text-xs text-blue-600 hover:underline">
                    수정
                  </Link>
                  <button className="text-xs text-red-600 hover:underline" onClick={() => handleDeletePost(post.id)}>
                    삭제
                  </button>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow mb-8 p-6">
            <div className="flex flex-col">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center relative group overflow-hidden">

              ...
              <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                <div className="p-4">
                  <div className="mb-4">
                    ...
                    {searchQuery && (
                      <div className="space-y-2">
                        <Link href={`/search?q=${encodeURIComponent(searchQuery)}&type=event`} className="block">
                  ...
                  <div className="mb-4">
                    ...
                    {searchQuery && (
                      <div className="space-y-2">
                        <Link href={`/search?q=${encodeURIComponent(searchQuery)}&type=user`} className="block">
                          <div className="flex items-center p-2 hover:bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    {searchQuery && (
                      <div className="space-y-2">
                        <Link href={`/search?q=${encodeURIComponent(searchQuery)}&type=place`} className="block">
                          <div className="flex items-center p-2 hover:bg-gray-50 rounded-lg">
                            <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center mr-3">
            ...
            <div className="flex items-center space-x-4">
              ...
              {user && (
                <>
                  ...
                  <Link href="/notifications" className="text-gray-700 hover:text-primary relative">
              ...
              {user ? (
                <>
                  ...
                  <Link href="/mypage" className="text-gray-700 hover:text-primary">
                    마이페이지
                  </Link>
